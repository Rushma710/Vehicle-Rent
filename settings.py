...
SOCIAL_AUTH_FACEBOOK_OAUTH2_REDIRECT_URI = 'http://127.0.0.1:8000/social-auth/complete/facebook/'
SOCIAL_AUTH_GITHUB_OAUTH2_REDIRECT_URI='http://localhost:8000/accounts/github/login/callback/ '
